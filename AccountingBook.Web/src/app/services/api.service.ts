...
export class ApiService {
  ...
  getMainAccountConfigs() {
    return this.http.get('/api/MainAccountConfig/GetMainAccountConfigList');
  }

  getMainAccountConfigsById(id: any) {
    return this.http.get('/api/MainAccountConfig/GetMainAccountConfigById?id=' + id);
  }

  getSelectedValuesByDimensionId(id: any) {
    return this.http.get('/api/FinancialDimensionValue/GetFinancialDimensionValueByDimensionId?dimensionId=' + id)
  }
